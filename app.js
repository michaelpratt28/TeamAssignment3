...
app.controller('NewsCtrl', function ($scope, $http) {
    ...
    $scope.sources = [
        ...
        { name: 'CNBC', sourceName: 'cnbc', imgUrl: 'cnbc-sm.png', topStories: [], primary: '#ffffff', secondary: '#231f20' },
        ...
        { name: 'Google News', sourceName: 'google-news', imgUrl: 'google-sm.png', topStories: [], primary: '#ffffff', secondary: '#4f94ef' },
        ...
        { name: 'The New York Times', sourceName: 'the-new-york-times', imgUrl: 'nyt-sm.png', topStories: [], primary: '#ffffff', secondary: '#060708' },
        { name: 'The Verge', sourceName: 'the-verge', imgUrl: 'tv-sm.png', topStories: [], primary: '#eeeeee', secondary: '#000000' },
        { name: 'The Wall Street Journal', sourceName: 'the-wall-street-journal', imgUrl: 'wsj-sm.png', topStories: [], primary: '#ffffff', secondary: '#171717' },
        { name: 'The Washington Post', sourceName: 'the-washington-post', imgUrl: 'wp-sm.png', topStories: [], primary: '#ffffff', secondary: '#000000' },
